                    ...
                    <?= isset($correctName) ? "is-valid" : null ?>" value="<?= $pre_data['name'] ?? $correctName || $name ??   null ?> ">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="radio" name="gender" id="female" value="Female" <?= (!isset($gender)) && $pre_data['gender'] == "Female" ? "checked" : null ?> <?= (isset($gender)) && $correctGender == "Female" ? "checked" : null ?>>
                                        <label for="female">Female</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td><input type="radio" name="gender" id="Others" value="Others" <?= (!isset($gender)) && $pre_data['gender'] == "Others" ? "checked" : null ?> <?= (isset($gender)) && $gender == "Others" ? "checked" : null ?>>
                        ...
                        ">
                            ...
                            <div class="mb-3 col-8 col-xl-6">
                                ...
                                <input type="date" id="birthday" name="date_of_birth" class="form-control <?= isset($errordate_of_birth) ? "is-invalid" : null ?><?= isset($correctdate_of_birth) ? "is-valid" : null ?>" value="<?= $pre_data['date_of_birth'] ?? null ?>">
